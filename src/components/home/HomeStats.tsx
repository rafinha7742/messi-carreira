...
export default function HomeStats({ games, goals, assists }: HomeStatsProps) {
  return (
    <section className="max-w-6xl mx-auto px-6 pt-16 pb-10">
      ...
      <div className="grid grid-cols-3 gap-px bg-white/10 mt-10 max-w-2xl rounded-lg overflow-hidden">
        {[
          { label: "Partidas", val: games },
          { label: "Gols", val: goals },
          { label: "Assistências", val: assists },
        ].map((s) => (
          <div key={s.label} className="bg-[#0A0C10] px-6 py-5">
            <div className="font-mono text-3xl md:text-4xl text-[#EDEAE3]">
